export const projectsList = [
  {
    ...
    name: "SIPS",
    description:
      "A project in collaboration with medical teams, the aim of which is to create a visual diagnostic questionnaire on swallowing problems for adults.",
    tags: ["Frontend", "React", "Redux", "NodeMailer"],
    demoUrl: "https://sips-study.web.app/",
  ...
  },
  {
    ...
    tags: ["Front&back", "React", "MySql", "Calender"],
    demoUrl: "https://r-fit-client-deploy.onrender.com/",
